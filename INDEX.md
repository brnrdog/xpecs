...
A registry of every archetype in the collection. Keep this table in sync when you
add, rename, or change the status of an archetype.
...
| [Separator](archetypes/elements/separator.md) | `separator` | 1.0.0 | stable | A thin divider that visually and semantically separates groups of content. |
| [Skeleton](archetypes/elements/skeleton.md) | `skeleton` | 1.0.0 | stable | A placeholder that mirrors the shape of content while it loads. |
| [Slider](archetypes/elements/slider.md) | `slider` | 1.0.0 | stable | A control for choosing a value or range by dragging a handle along a track. |
| [Spinner](archetypes/elements/spinner.md) | `spinner` | 1.0.0 | stable | A compact, indeterminate indicator that signals a short, ongoing wait. |
| [Switch](archetypes/elements/switch.md) | `switch` | 1.0.0 | stable | A control that toggles a single setting on or off with an immediate effect. |
| [Textarea](archetypes/elements/textarea.md) | `textarea` | 1.0.0 | stable | A multi-line field for entering and editing longer free-form text. |
| [Toggle Group](archetypes/elements/toggle-group.md) | `toggle-group` | 1.0.0 | stable | A set of toggles acting as a single control for single- or multi-selection. |
| [Toggle](archetypes/elements/toggle.md) | `toggle` | 1.0.0 | stable | A two-state button that can be turned on or off, often used in toolbars. |
| [Typography](archetypes/elements/typography.md) | `typography` | 1.0.0 | stable | The system of text styles — headings, body, and inline elements — that gives content hierarchy and rhythm. |

## Components

| Archetype | id | Version | Status | Summary |
| --------- | -- | ------- | ------ | ------- |
| [Accordion](archetypes/components/accordion.md) | `accordion` | 1.0.0 | stable | A stack of headers that expand and collapse to reveal or hide sections of content. |
| [Alert Dialog](archetypes/components/alert-dialog.md) | `alert-dialog` | 1.0.0 | stable | A blocking modal that interrupts to confirm a consequential or irreversible action. |
| [Alert](archetypes/components/alert.md) | `alert` | 1.0.0 | stable | An inline message that draws attention to important, contextual information. |
| [Breadcrumb](archetypes/components/breadcrumb.md) | `breadcrumb` | 1.0.0 | stable | A trail showing the current location within a hierarchy and the path back to the top. |
| [Button Group](archetypes/components/button-group.md) | `button-group` | 1.0.0 | stable | A set of related buttons joined into a single visual unit. |
| [Calendar](archetypes/components/calendar.md) | `calendar` | 1.0.0 | stable | A grid of dates for viewing a month and selecting one or more days. |
| [Card](archetypes/components/card.md) | `card` | 1.0.0 | stable | A self-contained surface that groups related content and actions into a single unit. |
| [Carousel](archetypes/components/carousel.md) | `carousel` | 1.0.0 | stable | A scrollable, paged set of items revealed a few at a time with navigation controls. |
| [Chart](archetypes/components/chart.md) | `chart` | 1.0.0 | stable | A visual encoding of data — bars, lines, areas, and more — that reveals patterns and comparisons. |
...
| [Menubar](archetypes/components/menubar.md) | `menubar` | 1.0.0 | stable | A horizontal bar of top-level menus exposing an application's commands. |
| [Navbar](archetypes/components/navbar.md) | `navbar` | 1.0.0 | stable | A persistent top-level bar that anchors identity and primary navigation across a product. |
...
| Archetype | id | Version | Status | Summary |
| --------- | -- | ------- | ------ | ------- |
| [Dashboard](archetypes/pages/dashboard.md) | `dashboard` | 1.0.0 | stable | An at-a-glance overview page that surfaces key metrics, status, and entry points to act. |
| [Landing Page](archetypes/pages/landing-page.md) | `landing-page` | 1.0.0 | stable | A standalone marketing page designed to convert a focused audience toward a single primary action. |
| [Pricing Page](archetypes/pages/pricing.md) | `pricing` | 1.0.0 | stable | A page that presents plans and their value to help a visitor choose and convert. |
| [Settings](archetypes/pages/settings.md) | `settings` | 1.0.0 | stable | A page for viewing and changing a user's or system's configuration, organized into sections. |
| [Sign In](archetypes/pages/sign-in.md) | `sign-in` | 1.0.0 | stable | A focused page that authenticates a returning user with minimal friction. |
